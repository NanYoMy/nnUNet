...
os.environ['nnUNet_raw'] = r'../data_result/nnUNet_raw'
os.environ['nnUNet_preprocessed'] =r'../data_result/nnUNet_preprocessed'
os.environ['nnUNet_results'] = r'../data_result/nnUNet_results'
