...
python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\nodeep_pred -c 2d -d 103 -f all  -tr nnUNetTrainerNoDeepSupervision

python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\unetBN_pred -c 2d -d 103 -f all  -tr nnUNetTrainerBN

python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\plainunet_pred -c 2d -d 103 -f all  -tr nnUNetTrainerUNetPlain

python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\IBunet_5_4_3_pred -c 2d -d 103 -f all  -tr nnUNetTrainerIBUNet_5_4_3

python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\IBunet_5_4_3_pred -c 2d -d 103 -f all  -tr nnUNetTrainerIBUNet_5_4

python 4_predict.py -i ../data_result/nnUNet_raw/Dataset103_CPSegmentation/imagesTs -o ../data_result\nnUNet_raw\Dataset103_CPSegmentation\IBunet_5_4_3_pred -c 2d -d 103 -f all  -tr nnUNetTrainerIBUNet_5
